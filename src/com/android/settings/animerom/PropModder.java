...
import com.android.settings.animerom.util.CMDProcessor;
import com.android.settings.animerom.util.Helpers;
...
public class PropModder extends PreferenceFragment implements
    ...
    private static final String LOG_STACK_PREF = "pref_log_stack";
    private static final String LOG_STACK_PERSIST_PROP = "persist_log_stack";
    private static final String LOG_STACK_PROP_0 = "ro.config.htc.nocheckin";
    private static final String LOG_STACK_PROP_1 = "ro.config.nocheckin";
    private static final String LOG_STACK_PROP_2 = "profiler.force_disable_ulog";
    private static final String LOG_STACK_PROP_3 = "profiler.force_disable_err_rpt";
    private static final String LOG_STACK_BUFFER = "1";

    private String placeholder;
    private String tcpstack0;
    private String logstack0;
    ...
    private CheckBoxPreference mLogStackPref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLogStackPref = (CheckBoxPreference) prefSet.findPreference(LOG_STACK_PREF);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (preference == mLogStackPref) {
            Log.d(TAG, "mLogStackPref.onPreferenceTreeClick()");
            value = mLogStackPref.isChecked();
            return doMod(null, LOG_STACK_PROP_0, String.valueOf(value ? LOG_STACK_BUFFER : DISABLE))
                    && doMod(null, LOG_STACK_PROP_1, String.valueOf(value ? LOG_STACK_BUFFER : DISABLE))
                    && doMod(null, LOG_STACK_PROP_2, String.valueOf(value ? LOG_STACK_BUFFER : DISABLE))
                    && doMod(LOG_STACK_PERSIST_PROP, LOG_STACK_PROP_3, String.valueOf(value ? LOG_STACK_BUFFER : DISABLE));
    ...
    public void updateScreen() {
        ...
        String log = Helpers.findBuildPropValueOf(LOG_STACK_PROP_0);
        if (log.equals(LOG_STACK_BUFFER)) {
            mLogStackPref.setChecked(true);
        } else {
            mLogStackPref.setChecked(false);
        }
